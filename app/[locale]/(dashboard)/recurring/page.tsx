...
} from "@/components/recurring/recurring-transaction-modal";
...
export default function RecurringTransactionsPage() {
  ...
  const [selectedTransaction, setSelectedTransaction] =
    useState<UIRecurringTransaction | null>(null);
  const [activeTab, setActiveTab] = useState("all");

  const {
    data: recurringData,
    error: recurringError,
    mutate: mutateRecurring,
  } = useSWR<{
  ...
  const handleUpdateTransaction = async (
    ...
    try {
      const response = await fetch(
        `/api/recurring-transactions/${selectedTransaction.id}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(formData),
      ...
      <div className="grid gap-4 lg:gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="bills" className="space-y-2 sm:space-y-4">
              {bills.length === 0 ? (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            handleUpdateReminder(reminder.id!, "paid")
                          }
          ...
          selectedTransaction
            ? {
                ...
                autoCreateTransaction:
                  selectedTransaction.autoCreateTransaction,
              }
            : undefined
        }
      />
