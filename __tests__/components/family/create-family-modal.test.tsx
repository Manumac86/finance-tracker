...
const mockUseFamilyGroup = require('@/hooks/use-family-group').useFamilyGroup;
...
describe('CreateFamilyModal', () => {
  ...
  test('should render step 1 (basic information) initially', () => {
    ...
    expect(screen.getByLabelText('URL Identifier (optional)')).toBeInTheDocument();
  ...
  test('should navigate to step 2 (financial settings) when next is clicked', async () => {
    ...
    expect(screen.getByLabelText('Monthly Family Budget (optional)')).toBeInTheDocument();
  ...
  test('should navigate to step 3 (permissions) from step 2', async () => {
    ...
    expect(screen.getByText('Members can view all transactions')).toBeInTheDocument();
    expect(screen.getByText('Members can edit shared budgets')).toBeInTheDocument();
  ...
  test('should update budget input', async () => {
    ...
    // Update budget
    const budgetInput = screen.getByLabelText('Monthly Family Budget (optional)');
