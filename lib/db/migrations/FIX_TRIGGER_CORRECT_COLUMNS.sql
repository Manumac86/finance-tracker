-- Fix the trigger function to use the correct column names
-- Your table has: previous_balance, new_balance (not balance_before, balance_after)
...
SELECT 'Balance history trigger fixed with correct column names!' as status;